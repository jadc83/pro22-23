...
como ningún otro valor de X en ninguna otra cadena de la lista) 
e Y es una cadena. La función debe devolver un diccionario donde 
la clave de cada elemento será la X y el valor asociado a dicha 
clave será la correspondiente Y.
